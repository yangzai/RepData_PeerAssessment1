...
```
The mean total number of steps taken each day is `r mean_steps_by_date`.  
The median total number of steps taken each day is `r median_steps_by_date`.
...
```
The 5-minuite interval, on average accross all days, with the maximum number if steps is `r interval_with_max_mean_steps`.
...
```
The new mean total number of steps taken each day is `r new_mean_steps_by_date`.  
The new median total number of steps taken each day is `r new_median_steps_by_date`.  
